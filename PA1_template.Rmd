...
```{r echo= TRUE}
     ...
     xyplot(steps ~ interval | dayIndicator,dayPatterns, layout = c(1, 2),type = "l",main="Average Steps by 5 minute Interval for Weekends and WeekdaysA", xlab = "Interval", ylab = "Number of steps", )
